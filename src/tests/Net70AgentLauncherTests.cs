...
{
    public class Net70AgentLauncherTests
    {
        ...
        private const string AGENT_NAME = "net70-agent.dll";
        ...
        private static readonly string[] SUPPORTED = new string[] {
            "netcore-1.1", "netcore-2.1", "netcore-3.1",
            "netcore-5.0", "netcore-6.0", "netcore-7.0"
        };

        private Net70AgentLauncher _launcher;
        private TestPackage _package;

        [SetUp]
        public void SetUp()
        {
            _launcher = new Net70AgentLauncher();
        ...
        private void CheckAgentPath(Process process, bool x86)
        {
            ...
            Assert.That(File.Exists(agentPath), $"Agent '{agentPath}' does not exist");
        }
